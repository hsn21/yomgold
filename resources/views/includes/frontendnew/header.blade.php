<header class="site__mobile-header">
            ...
            <div class="header">
                ...
                <div class="header__topbar-start">
                    <div class="topbar topbar--spaceship-start">
                        ...
                        <div class="topbar__item-text"><a class="topbar__link" href="{{route('pages.aboutus.about-us')}}">About Us</a></div>
                        <div class="topbar__item-text"><a class="topbar__link" href="{{route('pages.contactus.contact-us')}}">Contacts</a></div>
                        ...
                        <div class="topbar__menu">
                            ...
                            <div class="topbar__menu-body">
                                <a class="topbar__menu-item" href="#">
                                    <img src="{{asset('public/templates-assets/home/theme/images/languages/language-1.png')}}" alt=""><span>English</span>
                                </a>
                                <a class="topbar__menu-item" href="#">
                                    <img src="{{asset('public/templates-assets/home/theme/images/languages/language-2.png')}}" alt=""><span>French</span>
                                </a>
                                <a class="topbar__menu-item" href="#">
                                    <img src="{{asset('public/templates-assets/home/theme/images/languages/language-3.png')}}" alt=""><span>German</span>
                                </a>
                                <a class="topbar__menu-item" href="#">
                                    <img src="{{asset('public/templates-assets/home/theme/images/languages/language-4.png')}}" alt=""><span>Russian</span>
                                </a>
                                <a class="topbar__menu-item" href="#">
                                    <img src="{{asset('public/templates-assets/home/theme/images/languages/language-5.png')}}" alt=""><span>Italian</span>
                                </a>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <div class="departments__item-menu">
                                                <div class="megamenu departments__megamenu departments__megamenu--size--xl">
                                                    <div class="megamenu__image">
                                                        <img src="{{asset('public/templates-assets/home/theme/images/departments/departments-2.jpg')}}" alt="">
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-1of5">
    ...
    C-0.1,9.8-0.1,10.4,0.3,10.7z" />
                                            ...
                                            <div class="departments__item-menu">
                                                <div class="megamenu departments__megamenu departments__megamenu--size--lg">
                                                    <div class="megamenu__image">
                                                        <img src="{{asset('public/templates-assets/home/theme/images/departments/departments-1.jpg')}}" alt="">
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-3">
                                                            <ul class="megamenu__links megamenu-links megamenu-links--root">
    ...
    C-0.1,9.8-0.1,10.4,0.3,10.7z" />
                                            ...
                                            <div class="departments__item-menu">
                                                <div class="megamenu departments__megamenu departments__megamenu--size--md">
                                                    <div class="megamenu__image">
                                                        <img src="{{asset('public/templates-assets/home/theme/images/departments/departments-3.jpg')}}" alt="">
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-4">
                                                            <ul class="megamenu__links megamenu-links megamenu-links--root">
    ...
    C-0.1,9.8-0.1,10.4,0.3,10.7z" />
                                            ...
                                            <div class="departments__item-menu">
                                                <div class="megamenu departments__megamenu departments__megamenu--size--nl">
                                                    <div class="megamenu__image">
                                                        <img src="{{asset('public/templates-assets/home/theme/images/departments/departments-4.jpg')}}" alt="">
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-6">
                                                            <ul class="megamenu__links megamenu-links megamenu-links--root">
                                ...
                                <div class="suggestions__group">
                                    ...
                                    <div class="suggestions__group-content">
                                        <a class="suggestions__item suggestions__product" href="">
                                            <div class="suggestions__product-image image image--type--product">
                                                <div class="image__body">
                                                    <img class="image__tag" src="{{asset('public/templates-assets/home/theme/images/products/product-2-40x40.jpg')}}" alt="">
                                                </div>
                                            </div>
                                        ...
                                        <a class="suggestions__item suggestions__product" href="">
                                            <div class="suggestions__product-image image image--type--product">
                                                <div class="image__body">
                                                    <img class="image__tag" src="{{asset('public/templates-assets/home/theme/images/products/product-3-40x40.jpg')}}" alt="">
                                                </div>
                                            </div>
                                            <div class="suggestions__product-info">
                                        ...
                                        <a class="suggestions__item suggestions__product" href="">
                                            <div class="suggestions__product-image image image--type--product">
                                                <div class="image__body">
                                                    <img class="image__tag" src="{{asset('public/templates-assets/home/theme/images/products/product-4-40x40.jpg')}}" alt="">
                                                </div>
                                            </div>
                                            <div class="suggestions__product-info">
                            ...
                            <div class="account-menu">
                                <form class="account-menu__form">
                                    ...
                                    <div class="account-menu__form-link">
                                        <a href="{{route('user-registration-page')}}">Create An Account</a>
                                    </div>
                                </form>
                                <div class="account-menu__divider"></div>
                                <a href="" class="account-menu__user">
                                    <div class="account-menu__user-avatar">
                                        <img src="{{asset('public/templates-assets/home/theme/images/avatars/avatar-4.jpg')}}" alt="">
                                    </div>
                                    ...
                                    <li class="dropcart__item">
                                        <div class="dropcart__item-image image image--type--product">
                                            <a class="image__body" href="product-full.html">
                                                <img class="image__tag" src="{{asset('public/templates-assets/home/theme/images/products/product-4-70x70.jpg')}}" alt="">
                                            </a>
                                        </div>
    ...
    C9.2,7.8,9.2,8.4,8.8,8.8z" />
                                    ...
                                    <li class="dropcart__item">
                                        <div class="dropcart__item-image image image--type--product">
                                            <a class="image__body" href="product-full.html">
                                                <img class="image__tag" src="{{asset('public/templates-assets/home/theme/images/products/product-2-70x70.jpg')}}" alt="">
                                            </a>
                                        </div>
                                        <div class="dropcart__item-info">
                                            <div class="dropcart__item-name">
    ...
    C9.2,7.8,9.2,8.4,8.8,8.8z" />
                                    ...
                                    <li class="dropcart__item">
                                        <div class="dropcart__item-image image image--type--product">
                                            <a class="image__body" href="product-full.html">
                                                <img class="image__tag" src="{{asset('public/templates-assets/home/theme/images/products/product-5-70x70.jpg')}}" alt="">
                                            </a>
                                        </div>
                                        <div class="dropcart__item-info">
                                            <div class="dropcart__item-name">
