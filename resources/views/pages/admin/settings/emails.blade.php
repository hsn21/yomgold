      ...
      <div class="row">
        <div class="col-md-12">
          <table>
            ...
            <tr>
              <td><i class="fa fa-check-circle-o"></i> Forgot Password</td>
              <td><a href="{{ route('admin.emails_type_content', 'forgot-user-email') }}" class="btn btn-default btn-sm" data-toggle="tooltip" title="Configure"><i class="fa fa-cog"></i></a></td>
            </tr>
