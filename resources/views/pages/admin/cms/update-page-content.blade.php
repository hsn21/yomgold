...
<form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
 ...
 <br>
            <br>
              ...
              <div class="row">  
              <label class="col-sm-4 control-label" for="inputVisibility">Page Parent</label>
              <div class="col-sm-8">
                <select class="form-control select2" name="pages_parent" style="width: 100%;">
...
<option >Select Page</option>
              ...
              @foreach($pages_list as $row)
                  <option value="{!! $row['id'] !!}" @if($page_data_by_slug['parent_id'] == $row['id'])  selected="selected"  @endif >{!! $row['post_title'] !!}</option>     
                  @endforeach
                    @endif 
