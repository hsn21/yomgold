...
<div class="form-group">
          <div class="row">  
            <label class="col-sm-5 control-label" for="pkgprice">Package Price</label>
            <div class="col-sm-7">
              <input type="number" id="pkgprice" name="pkgprice" class="form-control" value="{{ $package_update_data['options']->vendor_package }}">
            </div>
          </div>  
        </div> 
