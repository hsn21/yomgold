...
<head>
    ...
    <!-- fonts -->
    <link rel="stylesheet" href="{{url('https://fonts.googleapis.com/css?family=Roboto:400,400i,500,500i,700,700i')}}">
    <!-- css -->
    ...
    <link rel="stylesheet" href="{{url('public/vendor/photoswipe/photoswipe.css')}}">
    <link rel="stylesheet" href="{{url('public/vendor/photoswipe/default-skin/default-skin.css')}}">
    <link rel="stylesheet" href="{{url('public/vendor/select2/css/select2.min.css')}}">
    <link rel="stylesheet" href="{{url('public/css/style.css')}}">
    <link rel="stylesheet" href="{{url('public/css/style.header-spaceship-variant-one.css')}}" media="(min-width: 1200px)">
    <link rel="stylesheet" href="{{url('public/css/style.mobile-header-variant-one.css')}}" media="(max-width: 1199px)">
    <!-- font - fontawesome -->
    <link rel="stylesheet" href="{{url('public/vendor/fontawesome/css/all.min.css')}}">
</head>
...
<body>
    ...
    <script src="{{url('public/vendor/photoswipe/photoswipe.min.js')}}"></script>
    <script src="{{url('public/vendor/photoswipe/photoswipe-ui-default.min.js')}}"></script>
    <script src="{{url('public/vendor/select2/js/select2.min.js')}}"></script>
    <script src="{{url('public/js/number.js')}}"></script>
