...
<header class="site__mobile-header">
            ...
            <div class="header">
                ...
                <div class="header__topbar-start">
                    <div class="topbar topbar--spaceship-start">
                        <div class="topbar__item-text d-none d-xxl-flex">Call Us: (+97) 123-456-789</div>
                        ...
                        <div class="indicator__content">
                            <div class="account-menu">
                                <form class="account-menu__form">
                                    ...
                                    <a href="{{route('user-registration-post')}}">Create An Account</a>
                                    </div>
                                </form>
	...
	C9.2,7.8,9.2,8.4,8.8,8.8z" />
                                ...
                                <div class="dropcart__actions">
                                    <a href="{{route('admin.shop_orders_list')}}" class="btn btn-secondary">View Cart</a>
                                    <a href="{{route('checkout-process')}}" class="btn btn-primary">Checkout</a>
                                </div>
                            </div>
                        </div>
                    </div>
