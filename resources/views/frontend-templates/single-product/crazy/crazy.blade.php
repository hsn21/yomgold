            ...
            <div class="tab-pane fade" id="vendorInfo">
              ...
              <table>
                <tr>
                  ...
                  @else
                  <td>{!! $vendor_details['user_display_name'] !!}</td>
                  @endif
                </tr>

                <tr><th>{!! trans('frontend.vendor_label') !!}</th><td><a target="_blank" href="{{ route('store-details-page-content', $vendor_details['user_display_name']) }}"><i>{!!  $vendor_details['user_display_name'] !!}</i></a></td></tr>
