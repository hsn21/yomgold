...
<span class="block-slideshow__item-image block-slideshow__item-image--desktop" style="background-image: url('{{ get_image_url($img->img_url) }}')"></span>
<span class="block-slideshow__item-image block-slideshow__item-image--mobile" style="background-image: url('{{ get_image_url($img->img_url) }}')"></span>
...
<h2 class="section-header__title">{!! trans('frontend.featured_products_label') !!}</h2>
...
<a class="info quick-view-popup image__body" data-id="{{ $features_product->id }}" >

@if(!empty($features_product->image_url))

<img class="image__tag" src="{{ get_image_url( $features_product->image_url ) }}" alt="{{ basename( get_image_url( $features_product->image_url ) ) }}">
@else
<img class="image__tag" src="{{ default_placeholder_img_src() }}" alt="">
@endif
...
<a class="info quick-view-popup" data-id="{{ $features_product->id }}">{!! $features_product->title !!}</a>
</div>
</div>
...
<div class="product-card__price product-card__price--current">@if( $features_product->type == 'simple_product' )
...
<a href="{{route('usercart',['id'=>$features_product->id])}}" data-id="{{ $features_product->id }}" data-toggle="tooltip" data-placement="top" title="{{ trans('frontend.add_to_cart_label') }}" class="product-card__addtocart-icon" type="button" aria-label="Add to cart">
...
<a href="" data-id="{{ $features_product->id }}" data-toggle="tooltip" data-placement="top" title="{{ trans('frontend.add_to_cart_label') }}" class="product-card__addtocart-icon" type="button" aria-label="Add to cart">
<svg width="20" height="20">
<circle cx="7" cy="17" r="2" />
<circle cx="15" cy="17" r="2" />
<path d="M20,4.4V5l-1.8,6.3c-0.1,0.4-0.5,0.7-1,0.7H6.7c-0.4,0-0.8-0.3-1-0.7L3.3,3.9C3.1,3.3,2.6,3,2.1,3H0.4C0.2,3,0,2.8,0,2.6
...
<div class="block-sale__header" style="
padding: 25px 80px;
">
<div class="block-sale__title">{!! trans('frontend.latest_label') !!}</div>
...
<div class="block-zone__widget" style="
width: 100%;
">
...
padding: 25px 80px;
">
<div class="block-sale__title">Most Sale</div>
