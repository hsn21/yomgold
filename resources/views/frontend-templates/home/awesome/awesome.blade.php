...
<a href="{{route('admin.add_product')}}">hhh Brandix Spark Plug Kit ASR-400</a>
</div>
</div>
...
<div class="product-card__image">
<div class="image image--type--product">
<a href="{{route('admin.add_product')}}" class="image__body">
...
<div class="product-card__name">
<div>
<a href="{{route('admin.add_product')}}">Brandix Brake Kit BDX-750Z370-S</a>
</div>
</div>
<div class="product-card__rating">
<div class="rating product-card__rating-stars">
...
<a href="{{route('admin.add_product')}}">Left Headlight Of Brandix Z54</a>
</div>
</div>
<div class="product-card__rating">
<div class="rating product-card__rating-stars">
...
<div class="product-card__name">
<div>
<a href="{{route('admin.add_product')}}">Twin Exhaust Pipe From Brandix Z54</a>
</div>
</div>
<div class="product-card__rating">
<div class="rating product-card__rating-stars">
...
<div class="product-card__name">
<div>
<a href="{{route('admin.add_product')}}">Brandix Engine Block Z4</a>
</div>
</div>
<div class="product-card__rating">
<div class="rating product-card__rating-stars">
...
<div class="product-card__name">
<div>
<a href="{{route('admin.add_product')}}">Set of Car Floor Mats Brandix Z4</a>
</div>
</div>
<div class="product-card__rating">
<div class="rating product-card__rating-stars">
...
<div class="block-sale__header" style="
    padding: 25px 80px;
">
<div class="block-sale__title">New Arrivals</div>
...
<a href="{{route('admin.add_product')}}">Brandix Spark Plug Kit ASR-400</a>
</div>
</div>
<div class="product-card__rating">
<div class="rating product-card__rating-stars">
...
<a href="{{route('admin.add_product')}}">Glossy Gray 19" Aluminium Wheel AR-19</a>
</div>
</div>
<div class="product-card__rating">
<div class="rating product-card__rating-stars">
...
<div class="product-card__name">
<div>
<a href="{{route('admin.add_product')}}">Motor Oil Level 5</a>
</div>
</div>
<div class="product-card__rating">
<div class="rating product-card__rating-stars">
...
<div class="product-card__name">
<div>
<a href="{{route('admin.add_product')}}">Brandix Clutch Discs Z175</a>
</div>
</div>
<div class="product-card__rating">
<div class="rating product-card__rating-stars">
...
">
  ...
  l0.6-0.6C9.3,2.4,10.3,2,11.3,2c1,0,1.9,0.4,2.6,1.1C15.4,4.6,15.4,6.9,13.9,8.4z" />
                                                ...
                                                <a href="{{route('admin.add_product')}}> <button class="product-card__addtocart-icon" type="button" aria-label="Add to cart">
                                                        <svg width="20" height="20">
                                                            <circle cx="7" cy="17" r="2" />
                                                            <circle cx="15" cy="17" r="2" />
                                                            <path d="M20,4.4V5l-1.8,6.3c-0.1,0.4-0.5,0.7-1,0.7H6.7c-0.4,0-0.8-0.3-1-0.7L3.3,3.9C3.1,3.3,2.6,3,2.1,3H0.4C0.2,3,0,2.8,0,2.6
...
<a href="{{ route('admin.add_product') }}">Check Stock</a>
<button class="product-card__addtocart-icon" type="button" aria-label="Add to cart">
<svg width="20" height="20">
<circle cx="7" cy="17" r="2" />
<circle cx="15" cy="17" r="2" />
