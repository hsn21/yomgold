...
class GetFunction
{
  ...
  public function sendCustomMail($data){
    $view          =  '';
    $get_view_data =  array();
    $site_title    =  'Amir Spare Parts';
    $email         =  'jaleelqamar@gmail.com';
    ...
    elseif($data['source'] == 'forgot_user_email'){
      $view                         =   'emails.forgot_user_email';
      $get_view_data['_view']        =   $view;
      $get_view_data['_mail_to']    =   $data['email'];
      $get_view_data['_new_password']    =   $data['new_password'];
      $get_view_data['_subject']    =   'Forgot Password';
    }
  ...
  public static function vendor_name_by_product_id($product_id){
    ...
    if(!empty($get_author_id)){
      ...
      if(!empty($get_role_id)){
        ...
        if(!empty($get_vendor_details) && $get_vendor_details->slug == 'vendor'){
          $vendor_details = get_user_details( $get_author_id->author_id );
          $vendor_name = '<a target="_blank" href="'. route('store-details-page-content', $vendor_details['user_display_name']).'"><i>'. $vendor_details['user_display_name'] .'</i></a>';
        }
      }
    }
