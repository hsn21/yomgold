...
// to fetch vendor documents on admin side
// Route::get('vendor/{vendor_name}/{documents}',function($vendor_name,$document){

//     $path=(storage_path('app/vendor/'.$vendor_name.'/'.$documents));
//     if (!File::exists($path)) {
//         abort(404);
//     }
//     $file = File::get($path);
...
//         return Response::make($file, 200,array('Content-Type'=>$type));

//   });

Route::get('publics/vendor/{vendor_name}/{document_name}',function($vendor_name,$document_name){

      $path=(storage_path('app/publics/vendor/'.$vendor_name.'/'.$document_name));
    if (!File::exists($path)) {
        abort(404);
    }
    $file = File::get($path);
...
//About us
    Route::get('/pages.about-us',[
        'uses' => 'Api\PagesController@about_us',
        'as' => 'pages.aboutus.about-us',
    ]);

//Contactus
    Route::get('/pages.contact-us',[
        'uses' => 'Api\PagesController@about_us',
        'as' => 'pages.contactus.contact-us',
    ]);
  ...
  Route::post( '/vendor/logout', [
    'uses' => 'Auth\LoginController@vendorLogout',
    'as'   => 'vendor.logout'
  ]);
...
Route::get( '/vendor/forgot-password', [
    'uses' => 'Auth\ForgotPasswordController@redirectForgotPassword',
    'as' => 'vendor-forgotPassword'
  ]);

  Route::post( '/vendor/forgot-password', [
    'uses' => 'Auth\ForgotPasswordController@manageVendorForgotPassword',
    'as' => 'vendor-forgotPassword'
  ]);
...
Route::get('/vendor/login',function(){
    return view('pages.auth.vendor-login');
})->name('vendor.login');

Route::post('/vendor/login','Auth\LoginController@VendorLogin')->name('vendor.login');
...
Route::get('/usercart/{id}', [
    'uses' => 'Frontend\FrontendManagerController@addtocart',
    'as'   => 'usercart'
  ]);
...
Route::get('/page/sell-on-yom-gold',function(){

    return view('pages.footer.selling');

})->name('footer.selling');

// Route::get('/page/sell-on-yom-gold-buisness',function(){

//   return view('pages.footer.buisness');


// })->name('footer.buisness');


// Route::get('/page/get-affiliated-with-yom-gold',function(){

//   return view('pages.footer.affiliated');


// })->name('footer.affiliated');
...
Route::get('/fetch-parent-cats', [
    'uses' => 'CategoryController@fetchParentCats',
    'as'   => 'fetch-parent-cats'
  ]);
Route::get('/fetch-cat-products', [
    'uses' => 'CategoryController@fetchCatProducts',
    'as'   => 'fetch-cat-products'
  ]);
